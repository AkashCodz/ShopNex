          ...
          <div className="max-w-md w-full p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-black text-white p-2 rounded-md hover:bg-gray-800 focusOutline-none focus:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900 transition-colors duration-300"
                >
                  Sign Up
                </button>
              </div>
