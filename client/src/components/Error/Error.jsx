    ...
    <div className="container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12">
        <div className="wf-ull lg:w-1/2">
            ...
            <div className="flex items-center mt-6 gap-x-3">
                ...
                <Link to="/all" className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg shrink-0 sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
                    Take me home
                </Link>
            </div>
        ...
        <div className="relative w-full mt-8 lg:w-1/2 lg:mt-0">
            <img className=" w-full h-full md:h-full rounded-2xl" src="https://cdn.dribbble.com/users/2771385/screenshots/16267270/comp_2-min.gif" alt=""/>
        </div>
    </div>
</section>
    </>
